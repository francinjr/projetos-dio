...
public class FinanceController {
	...
	@Operation(summary = "Finds all finances", description = "Finds all finances", tags = {
			"Finances" }, responses = {
					@ApiResponse(description = "Sucess", responseCode = "200", content = {
							@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = FinanceDTO.class)))
	...
	@Operation(summary = "Finds a finance", description = "Finds a finance", tags = {
			"Finances" }, responses = {
					@ApiResponse(description = "Sucess", responseCode = "200", content = @Content(schema = @Schema(implementation = FinanceDTO.class))),
	...
	@Operation(summary = "Adds a new finance", description = "Adds a new finance by passing in a JSON, XML or YML representation of the finance!", tags = {
			"Finances" }, responses = {
					@ApiResponse(description = "Created", responseCode = "201", content = @Content(schema = @Schema(implementation = FinanceDTO.class))),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Internal Server Error", responseCode = "500", content = @Content),
			})
	...
	@Operation(summary = "Updates a finance", description = "Updates a finance by passing in a JSON, XML or YML representation of the finance!", tags = {
			"Finances" }, responses = {
					@ApiResponse(description = "Updated", responseCode = "200", content = @Content(schema = @Schema(implementation = FinanceDTO.class))),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Server Error", responseCode = "500", content = @Content),
